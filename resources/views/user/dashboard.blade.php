              ...
              <div class="card-body p-0">
                    <form>
                          ...
                          <div class="row no-gutters justify-content-between mt-3 px-3 pb-3">
                            <div class="col">
                              <button class="btn btn-light btn-sm bg-light rounded-capsule shadow-none d-inline-flex align-items-center fs--1 ml-1 mb-0" type="button"><img class="cursor-pointer" src="{{asset('user-dash/images/illustrations/image.svg')}}" width="17" alt="" /><span class="ml-2 d-none d-md-inline-block">Image</span></button>
                              <button class="btn btn-light btn-sm bg-light rounded-capsule shadow-none d-inline-flex align-items-center fs--1 ml-1" type="button"><img class="cursor-pointer" src="{{asset('user-dash/images/illustrations/calendar.svg')}}" width="17" alt="" /><span class="ml-2 d-none d-md-inline-block">Event</span></button>
                              <button class="btn btn-light btn-sm bg-light rounded-capsule shadow-none d-inline-flex align-items-center fs--1 ml-1" type="button"><img class="cursor-pointer" src="{{asset('user-dash/images/illustrations/video-camera.png')}}" width="17" alt="" /><span class="ml-2 d-none d-md-inline-block text-nowrap">Video</span></button>
                            </div>
                            <div class="col-auto">
